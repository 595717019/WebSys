...
<script type="text/javascript">
	websys.addScript("static/js/myjs/map.js");
</script>
</head>
<body>
						...
						<div class="widget-body">
							<div class="widget-main">
								...
								<div class="step-content row-fluid position-relative">
									<div style="float: left;">
										经度： <span class="input-icon"> <input type="text"
											id="ZUOBIAO_Y2" title="" value="" style="width: 79%;"
											disabled="disabled"> <i class="icon-fire"></i>
										</span> 纬度： <span class="input-icon"> <input type="text"
											id="ZUOBIAO_X2" title="" value="" style="width: 79%;"
											disabled="disabled"> <i class="icon-fire"></i>
										</span>
									</div>
									<div style="margin-top: -5px;">
								...
								<div class="step-content row-fluid position-relative">
									<div style="float: left;">
										距离： <span class="input-icon"> <input type="text"
											id="distance" title="" value="" style="width: 200px;"
											disabled="disabled"> <i class="icon-dashboard"></i>
										</span>
									</div>
									<div style="margin-top: -5px;">
										千米&nbsp;&nbsp;
