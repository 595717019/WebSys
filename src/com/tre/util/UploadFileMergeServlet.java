...
@WebServlet("/UploadFileMerge")
public class UploadFileMergeServlet extends HttpServlet
{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		if (action.equals("mergeChunks"))
		{
			...
			// MD5文件名
			// File outputFile = new File(savePath+"/"+fileMd5+".mp4");0
			File outputFile = new File(savePath + "/" + fileMd5 + ext);
			// 创建文件
			...
			// 文件路径
			String rspJson = "{\"fileMd5\":\"" + fileMd5 + "\",\"filePath\":\"" + folad + "\"}";
