package com.tre.controller.information.pictures;
...
import com.tre.service.information.pictures.PicturesService;
				...
				if (null != DATA_IDS && !"".equals(DATA_IDS))
				{
					...
					for (int i = 0; i < pathList.size(); i++)
					{
						DelAllFile.delFolder(
								PathUtil.getClasspath() + Const.FILEPATHIMG + pathList.get(i).getString("PATH"));
					}
