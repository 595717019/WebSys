package com.tre.controller.system.tools;
...
import com.tre.util.MapDistance;
import com.tre.util.PageData;
import com.tre.util.PathUtil;
import com.tre.util.TwoDimensionCode;

/**
* @Description: 工具类
* @author 10097454
* @date 2017/11/30 11:49:14
 */
@Controller
...
public class ToolController extends BaseController {
    ...
    * @Description: 百度上传插件
    ...
    public ModelAndView fileUpLoad() throws Exception {
        ...
        PageData pd = new PageData();
        pd = this.getPageData();
        mv.setViewName("system/tools/webuploader");
        mv.addObject("pd", pd);
        return mv;
    }
    ...
    * @Description: HTML动态拼接
    ...
    public ModelAndView eval() throws Exception {
        ...
        PageData pd = new PageData();
        pd = this.getPageData();
        mv.setViewName("system/tools/eval");
        mv.addObject("pd", pd);
        return mv;
    }
